...
#define CHANNEL_CODETALK	(B) //Modified from Code Council chan by Zeus
...
#define CHANNEL_BUILDTALK	(S) //Zeus
#define CHANNEL_ARENA         (T) //ARENA
...
#define CHANFLAG_CODETALK			(G)
#define CHANFLAG_NSCHAT				(H)
...
#define CHANFLAG_BUILDTALK			(O)
#define CHANFLAG_BUSY				(P)

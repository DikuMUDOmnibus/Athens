...
DECLARE_DO_FUN( do_arena   ); //add this for arena talk channel 
DECLARE_DO_FUN( do_armies ); // does clanlist
...
/*DECLARE_DO_FUN( do_holylight		        );
  ...
  DECLARE_DO_FUN( do_holyvnum			);*/ //removed by Zeus
...
//DECLARE_DO_FUN(	do_holywalk			); //removed by Zeus
...
DECLARE_DO_FUN( do_relevel ); // Zeus
DECLARE_DO_FUN( do_holyset ); // Zeus

/*Marriage functions added by Zeus*/
DECLARE_DO_FUN( do_marry );
DECLARE_DO_FUN( do_divorce );
DECLARE_DO_FUN( do_spousetalk );
DECLARE_DO_FUN( do_consent );

/*Misc other new functions by Zeus*/
DECLARE_DO_FUN( do_quests );
DECLARE_DO_FUN( do_buildtalk );
DECLARE_DO_FUN( do_nschat );
DECLARE_DO_FUN( do_immadvance );
DECLARE_DO_FUN( do_award );		// Oct 17 04
DECLARE_DO_FUN( do_nspload );		// Oct 27 04
DECLARE_DO_FUN( do_roulette );		// Dec 24 04
//DECLARE_DO_FUN( do_addquest );		// Dec 25 04

// Jan 05 
DECLARE_DO_FUN( do_accept ); 
DECLARE_DO_FUN( do_challenge ); // arena stuff 
...
DECLARE_DO_FUN( do_athensflag	);  //army flag quest toggle
DECLARE_DO_FUN( do_megaraflag	);  //army flag quest toggle
DECLARE_DO_FUN( do_flags	);  //info on flag possession for players
DECLARE_DO_FUN( do_aflag	);  //mortal command to control flags
//DECLARE_DO_FUN( do_event	);
//DECLARE_DO_FUN( do_checkevent	);
DECLARE_DO_FUN( do_powers );
DECLARE_DO_FUN( do_chain );
DECLARE_DO_FUN( do_bolt );
DECLARE_DO_FUN( do_romance );
DECLARE_DO_FUN( do_sober );
DECLARE_DO_FUN( do_drunk );
DECLARE_DO_FUN( do_powerhelp );
DECLARE_DO_FUN( do_bless );
DECLARE_DO_FUN( do_shout );
DECLARE_DO_FUN( do_transform );
DECLARE_DO_FUN( do_assassinate );
DECLARE_DO_FUN( do_assassins );
DECLARE_DO_FUN( do_typhoon );
DECLARE_DO_FUN( do_apple );

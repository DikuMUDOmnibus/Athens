...
//#define ACT2_IS_NPC 		(A) is left free incase an ACT2_IS_NPC flag is needed
...
#define ACT2_PLR_ARENA  	(F)  //arena stuff 
#define ACT2_PLR_BET            (G)  //arena bettin system 
#define ACT2_PLR_CANSEE         (H)  //arena use for accept
#define ACT2_PLR_WAGER		(I) //applebet wager system
#define ACT2_PLR_EVENT	(J) //events and contests to join
...
#define ITEM_POLE			42
#define ITEM_FISH			43
#define ITEM_FINISH			44
#define ITEM_FLYER			45
#define ITEM_ATHENSFLAG                 45
#define ITEM_MEGARAFLAG			46
#define ITEM_CARGO			47
#define ITEM_COMMODITY			48
#define ITEM_POT			49
#define ITEM_PAN                        50
...
#define OBJEXTRA2_STRIP_ON_QUIT (Q)
#define OBJEXTRA2_ROULETTE_1   (R) 
#define OBJEXTRA2_ROULETTE_2   (S)
#define OBJEXTRA2_ITEM_FOR_TRADE   (T)

//exra flags 3 - Used in #OBJECTS
#define OBJEXTRA3_TEST			(A)
...
#define ROOM2_QUITTABLE		(C) // Mortals can quit here
#define ROOM2_FISH		(D) // Fishing Spots
#define ROOM2_ATHENSFLAG	(E) // Athens Flag Pole
#define ROOM2_MEGARAFLAG	(F)
...
#define PLR_CONSENT                      (M) //Marriage Code

#define PLR_HOLYLIGHT			(N)
#define PLR_HOLYNAME			(O)

#define PLR_TRADING			(P)
...
//Job bits for players.
#define JOB_IS_NPC			(A)//use it and you'll be sorry
#define JOB_JOB				(B)
#define JOB_CITY_GUARD			(C)
#define JOB_LT_GUARD			(D)
#define JOB_CARTOGRAPHER		(E)
...
#define CODEHELP_ALL_BUT_PLAYERS  (	CODEHELP_LOG	|CODEHELP_NO_HELPFILE |CODEHELP_IMM	|CODEHELP_ADMIN |CODEHELP_WIZNET)

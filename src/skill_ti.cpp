...
void do_worship(char_data *ch, char *argument)
{
	...
	if ( (ch->deity != NULL) && (ch->deity->name != NULL) ) {
		...
		ch->printlnf( "It is a serious matter to switch your Patron Diety.
				\n\rIf you wish to change who you worship you must speak to an Immortal.
				\n\rThey will then assist you in choosing a new Diety, but it will come
				\n\rat a cost to you." );
		return;
	}

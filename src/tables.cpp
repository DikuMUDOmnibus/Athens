...
{	
	...
	{  "no_tendency",		ACT2_NO_TENDENCY,		true	},	
   	{  "arenaplayer",       ACT2_PLR_ARENA,         false   }, 
   	{  "eventplayer",       ACT2_PLR_EVENT,         false   }, 
   	{  "cansee",            ACT2_PLR_CANSEE,        false   }, 
   	{  "madearenabet",      ACT2_PLR_BET,           false   }, 	
	{  NULL,				0,						0   }
};
...
const struct flag_type room2_flags[]=
{
	...
	{ "quittable",		ROOM2_QUITTABLE,	true	},	
	{ "fish",		ROOM2_FISH,		true	},
	{ "athensflag",		ROOM2_ATHENSFLAG,	true	},
	{ "megaraflag",		ROOM2_MEGARAFLAG,	true	},
	{  NULL,                0,                      0		}
};
...
const struct flag_type item_types[] =
{
    ...
    {  "athensflag",    ITEM_ATHENSFLAG,          true    },
    {  "boat",          ITEM_BOAT,          true    },
    {  "cargo",          ITEM_CARGO,          true    },
    {  "cauldron",      ITEM_CAULDRON,      true    },
    {  "clothing",      ITEM_CLOTHING,      true    },
    {  "commodity",      ITEM_COMMODITY,      true    },
    {  "component",     ITEM_COMPONENT,     true    },
    {  "container",     ITEM_CONTAINER,     true    },
    {  "drinkcontainer",ITEM_DRINK_CON,     true    },
    {  "fish", 		ITEM_FISH,	    true    },
    {  "finish",	ITEM_FINISH,	    true    },
    {  "flask",         ITEM_FLASK,         true    },
    {  "flyer", 	ITEM_FLYER,	    true    },	
    {  "food",          ITEM_FOOD,          true    },
    ...
    {  "map",           ITEM_MAP,           true    },
    {  "megaraflag",    ITEM_MEGARAFLAG,          true    },
...
const struct flag_type objextra2_flags[]=
{
	...
	{  "strip_on_quit",     OBJEXTRA2_STRIP_ON_QUIT,         true    },
...
// not to be set in olc, will have it's own command since it will be a bit more specialized
	...
	{  "item for trade",     OBJEXTRA2_ITEM_FOR_TRADE,         false   },
...
/*const struct flag_type objextra3_flags[]=
}
 {  "test",         OBJEXTRA3_TEST,                true },
 {  NULL,                    0,          0   }
};*/
...
const  struct  flag_type  to_types[]=
{
	...
	//{  "objextra3",                 WHERE_OBJEXTRA3,                false   },      // object
...
const struct flag_type plr_flags[] =
{
	...
	{ "trading",            PLR_TRADING,             false   },
	{  NULL,		 0,  0	 }
};

const struct flag_type job_flags[] =
{
	{ "job",		JOB_JOB,		true   },
	{ "city_guard",         JOB_CITY_GUARD,     	true   },
        { "lt_guard",           JOB_LT_GUARD,          	true   },
	{ "cartographer",	JOB_CARTOGRAPHER,	true   },
	/*{ "",						true   },
	{ "",						true   },*/
	{  NULL,		0,			0      },
};
...
const struct flag_type affect2_flags[] = // some false to implemented?
{
	...
	{ "gnat",		AFF2_GNAT,		true	}, // place holder
	{  NULL,	 0,  0	 }
};
...
const struct flag_type council_flags[] =
{
	...
	{  "dept_head",		COUNCIL_DEPT_HEAD,		true	},
	{   NULL,			0,							false	}
};
/**************************************************************************/

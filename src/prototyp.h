...
void    append_event( char_data *ch, char *file, char *str );
...
//char	*extra3_bit_name( int extra_flags );
...
void    append_event_to_file( char_data *, char *file, char *str );
...
//***************************************************
	...
	void info_broadcast(char_data *ch, char * fmt, ...) __attribute__ ((format(printf,2,3)));
      void arena_broadcast(char_data *ch, char * fmt, ...) __attribute__ ((format(printf,2,3)));
#endif

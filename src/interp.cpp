...
*/	
	...
	*/	
	...
	{ "attrib",			do_attributes,			POS_DEAD,		0,	LOG_NORMAL, 	0 },
	...
	{ "multicheck",			do_multicheck,		POS_DEAD,		L3,	LOG_NORMAL,	0 },
	{ "orde",			do_order,			POS_RESTING,	0,	LOG_PALWAYS,	0 },
	{ "pinf",			do_pinfo,			POS_DEAD,		L7, LOG_NORMAL, 	0 },
        { "play",                      do_play,                       POS_STANDING,   0,      LOG_ALWAYS,     1 },
	{ "playerwipe",		do_playerwipe,		POS_DEAD,		ML,	LOG_ALWAYS,	0 },
	{ "practic",		do_practice,		POS_SLEEPING,	0,	LOG_NORMAL, 	0 },
	{ "prefi",			do_prefi,			POS_DEAD,		IM, LOG_NORMAL, 	0 },
	{ "punish",			do_punish,			POS_RESTING,	0,	LOG_ALWAYS,	0 },
	{ "quests",			do_listquest,		POS_DEAD,		0,	LOG_NORMAL, 	0 },
...
//	{ "recit",			do_recite,			POS_RESTING,	0,	LOG_NORMAL, 	0 },
	...
	{ "-",		do_buildtalk, POS_DEAD,	IM,	LOG_NORMAL,		0 },
	{ "accept",            do_accept,             POS_STANDING,      0,     LOG_NORMAL,     1 }, 
	{ "add",			do_add, 			POS_DEAD,		0,	LOG_ALWAYS, 	1 },
        { "advertise",              do_advertise,            POS_DEAD,               0,      LOG_ALWAYS,     1 },
	...
	{ "appoint",		do_appoint,		POS_RESTING,		0,	LOG_ALWAYS,	0 },
	{ "areas",			do_areas,			POS_DEAD,		0,	LOG_NORMAL, 	1 },
	{ "areasalpha",		do_areasalpha,		POS_DEAD,		0,	LOG_NORMAL, 	1 },
	{ "arena",      do_arena,       POS_DEAD,      0,   LOG_NORMAL,    1 }, 
	{ "askname",		do_askname, 		POS_RESTING,	0,	LOG_NORMAL, 	0 },
        { "assassinate",            do_assassinate,            POS_STANDING,    0,      LOG_NORMAL,     0 },
	{ "athensflag",  do_athensflag, POS_DEAD, ML, LOG_ALWAYS, },
	{ "attributes",		do_attributes,		POS_DEAD,		0,	LOG_NORMAL, 	1 },
	...
	{ "bet",      do_bet,          POS_RESTING,      0,   LOG_NORMAL,    1 }, 
...
//	{ "clanranks",		do_clanranks,		POS_DEAD,		0,	LOG_NORMAL, 	1 },
	...
	{ "decline",           do_decline,            POS_DEAD,          0,     LOG_NORMAL,     1 }, 
	...
	{ "dismiss",		do_dismiss,		POS_RESTING,	0,	LOG_ALWAYS,	0, },
...
//	{ "draw",			do_draw,			POS_RESTING,	0,	LOG_NORMAL, 	1 },
	...
	{ "doublexp",		do_doublexp,		POS_DEAD,	0,	LOG_ALWAYS,	1 },
	...
	{ "fish",		do_fish,		POS_RESTING,	0,	LOG_NORMAL, 1},
	{ "flags",		do_flags,		POS_RESTING,	0,	LOG_NORMAL, 1},
...
//	{ "land",			do_land,			POS_RESTING,	0,	LOG_NORMAL, 	1 },
	...
	{ "megaraflag",  do_megaraflag, POS_DEAD, ML, LOG_ALWAYS, },
...
//	{ "noteach",		do_noteach, 		POS_DEAD,		0,	LOG_NORMAL, 	1 },
	...
	{ "nspload",            do_nspload,             POS_DEAD,       0,      LOG_ALWAYS,     1 },
...
//	{ "quaff",			do_quaff,			POS_RESTING,	0,	LOG_NORMAL, 	1 },
	{ "contests",		do_quests,		POS_RESTING,		0,	LOG_NORMAL,	1 },
	//{ "addquest",		do_addquest,		POS_DEAD,		0,	LOG_NORMAL,	1 },
...
//	{ "race", 		do_race,		POS_STANDING,		0,	LOG_NORMAL,	1 },
//	{ "race2",		do_race2,		POS_STANDING,		0,	LOG_NORMAL,	1 },
//        { "race3",               do_race,                POS_STANDING,           0,      LOG_NORMAL,     1 },
//        { "race4",              do_race2,               POS_STANDING,           0,      LOG_NORMAL,     1 },
//        { "race5",              do_race2,               POS_STANDING,           0,      LOG_NORMAL,     1 },
//        { "race6",              do_race2,               POS_STANDING,           0,      LOG_NORMAL,     1 },
	{ "racestats",		do_racestats,		POS_DEAD,		0,	LOG_NORMAL, 	1 },
	{ "raceinfo",		do_raceinfo, 		POS_DEAD,		0,	LOG_NORMAL,		1 },	
        { "rank",             do_clanranks,           POS_DEAD,               0,      LOG_NORMAL,     0 },
...
//	{ "recite", 		do_recite,			POS_RESTING,	0,	LOG_NORMAL, 	1 },
	...
	{ "roulette",		do_roulette,	POS_RESTING,		0,	LOG_NORMAL,	1 },
...
//	{ "sheathe",		do_sheathe, 		POS_STANDING,	0,	LOG_NORMAL, 	1 },
	{ "sip",		do_quaff,		POS_RESTING,	0,	LOG_NORMAL,	1	},
...
//	{ "sing",			do_sing,			POS_DEAD,		IM, LOG_NORMAL, 1 },
	// Beginning of bards
...
//	{ "trade",	do_trade,			POS_DEAD,		0,	LOG_NORMAL, 	1 },
	...
	{ "vote",			do_vote,			POS_DEAD,		0,	LOG_ALWAYS, 	1 },
        { "wager",            do_wager,             POS_SLEEPING,   0,      LOG_NORMAL,     1 },
...
//	{ "vault",			do_vault,			POS_STANDING,	IM,  LOG_ALWAYS,	0 },
	...
	{ "relevel",            do_relevel,             POS_RESTING,             0,    LOG_ALWAYS,      0 }, // /*charles*/
	...
	{ "immadvance", do_immadvance, POS_DEAD, 1, LOG_ALWAYS, },
	{ "award", do_award, POS_DEAD, 0, LOG_ALWAYS, },
//	{ "event", do_event, POS_DEAD, 0, LOG_ALWAYS, },
//	{ "checkevent", do_checkevent, POS_DEAD, 0, LOG_ALWAYS, },	
	{ "powers", do_powers, POS_DEAD, IM, LOG_ALWAYS, 1 },
	{ "chain", do_chain, POS_DEAD, IM, LOG_ALWAYS, 1 },
	{ "bolt", do_bolt, POS_DEAD, IM, LOG_ALWAYS, 1 },
	{ "romance", do_romance, POS_DEAD, IM, LOG_ALWAYS, 1 },
	{ "sober", do_sober, POS_DEAD, IM, LOG_ALWAYS, 1 },
	{ "drunk", do_drunk, POS_DEAD, IM, LOG_ALWAYS, 1 },
	{ "powerhelp", do_powerhelp, POS_DEAD, IM, LOG_ALWAYS, 1 },
	{ "bless", do_bless, POS_DEAD, IM, LOG_ALWAYS, 1 },
	{ "shout", do_shout, POS_DEAD, IM, LOG_ALWAYS, 1 },
        { "assassins", do_assassins, POS_DEAD, IM, LOG_ALWAYS, 1 },
	{ "typhoon", do_typhoon, POS_DEAD, IM, LOG_ALWAYS, 1 },
        { "apple", do_apple, POS_DEAD, IM, LOG_ALWAYS, 1 },
        { "discord", do_discord, POS_DEAD, IM, LOG_ALWAYS, 1 },
	...
	{ "armies",            do_clanlist,            POS_DEAD,               IM,     LOG_NORMAL,       1 },
	...
	{ "bounty",		do_bounty,		POS_RESTING,	0,	LOG_NORMAL,	0 },
...
//	{ "clist",		do_clanlist,		POS_DEAD,		IM,	LOG_NORMAL,		1 },
	...
	{ "buildtalk",	do_buildtalk, POS_DEAD,	IM,	LOG_NORMAL,		0 },
	{ "btalk",		do_buildtalk, POS_DEAD,	IM,	LOG_NORMAL,		0 },
	...
	{ "aflag",	do_aflag,			POS_DEAD,		L4,	LOG_ALWAYS,		1 },
	...
	{ "gecho",		do_gecho,	        POS_DEAD,		L4,	LOG_NORMAL,		1 },
	{ "got",		do_goto,	        POS_DEAD,		L8,	LOG_NORMAL,		0 },
	{ "goecho", 		do_goecho,		POS_DEAD,		L4,	LOG_NORMAL,		1 },
	...
	{ "holyset",            do_holyset,             POS_DEAD,               IM,     LOG_ALWAYS,             1 },
	...
	{ "nschat", 	do_nschat,	POS_DEAD,	IM,	LOG_NORMAL,		0 },
	...
	{ "transform", do_transform, POS_DEAD, IM, LOG_ALWAYS, 1 },
...
void do_commands( char_data *ch, char *argument )
{
	...
	for (j=mincat;j<=maxcat;j++)
	{
		...
		if (!IS_NEWBIE_SUPPORT(ch) && j == COMCAT_NSUPPORT)
				continue;
		if (!IS_NOBLE(ch) && j == COMCAT_POLITICS)
				continue;

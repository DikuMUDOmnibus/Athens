...
#define CHK_JOB		(82)
#define CHK_ATHENSFLAG_ATHENS (83)
...
const	struct	fn_keyword_type		fn_keyword[] =
{
    ...
    //{"ispoliceoff",	"if ispoliceoff $n - is $n police officer"},
	...
	{"job",		"job flags"},
	{"athensflag_athens",		"athens city flag"},
    {"", ""},	// Table terminator 
};
...
//				vnum, numval, numpercent,	numval>numpercent?"true":"false");	
	...
	//case CHK_ISPOLICEOFF:
	//	return(lval_char != NULL && IS_POLICE_OFFICER(lval_char));
	...
	case CHK_ACT2:
       ...
       case CHK_JOB:
               return( lval_char != NULL
                        &&  IS_SET(lval_char->job, flag_lookup(buf, job_flags)) );

       case CHK_ATHENSFLAG_ATHENS:
			{

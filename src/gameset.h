...
struct game_settings_type{
	...
	int		obj_vnum_rose;
        int             obj_vnum_egg;
	int		obj_vnum_gemstone;
	int		obj_vnum_fishcatch;
	int		obj_vnum_raft;
...
#define GAMESET2_ASSASSINS               (Z)
#define GAMESET2_ATHENSFLAG_ATHENS                  (aa)
#define GAMESET2_ATHENSFLAG_MEGARA              (bb)
#define GAMESET2_MEGARAFLAG_ATHENS  		(cc)
#define GAMESET2_MEGARAFLAG_MEGARA              (dd)
#define GAMESET2_APPLEBET              (ee)

...
bool check_parse_name( char *name )
{
	...
	if(is_name( name, 
		...
		"hercules haides ajax persephone psyche echo hebe hectate apollo"
		"hestia hades hermes nymph goddess god helen gaia uranus herakles"
		"megera vashiva dashiva tinkle tanis sanctus rhuid rude"))
        return false;

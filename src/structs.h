...
typedef struct  roulette_data         ROULETTE_DATA;
...
//	bool				enchanted; // removed - Kal, Jan 00.
   ...
   //roulette table data needed to run roulette game
   char_data         *roulette_player1;
   char_data         *roulette_player2;
   char_data         *roulette_player3;

   // roulette bets goes bet#_player#
   int               roulette_bet_1_1;
   int               roulette_bet_1_2;
   int               roulette_bet_1_3;
};

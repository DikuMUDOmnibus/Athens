...
#define IS_CREATOR(ch)			(TRUE_CH(ch)->level>=99)
#define IS_SRADMIN(ch)			(TRUE_CH(ch)->level>=98)
#define IS_JRADMIN(ch)			(TRUE_CH(ch)->level>=97)
#define IS_CODER(ch)			(TRUE_CH(ch)->level>=96)
#define IS_IBUILDER(ch)			(TRUE_CH(ch)->level>=95)

#define IS_REMORTS(ch)			(TRUE_CH(ch)->councils,COUNCIL_REMORTS)
...
#define IS_JOB(ch)			  (IS_SET(TRUE_CH(ch)->job, JOB_JOB))
#define IS_CITY_GUARD(ch)		  (IS_SET(TRUE_CH(ch)->job, JOB_CITY_GUARD))
#define IS_LT_GUARD(ch)                  (IS_SET(TRUE_CH(ch)->job, JOB_LT_GUARD))
...
//#define IS_OBJ3_STAT(obj, stat) (IS_SET((obj)->extra3_flags, (stat)))

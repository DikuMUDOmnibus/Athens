...
void build_fire( char_data *ch, int chance )
{
	...
	{
		ch->println("You can't seem to remember Prometheus' lessons.");
	...
	act("$n uses the skills taught to mortals by Prometheus to create a fire.",ch,NULL,NULL,TO_ROOM);
	ch->println("Remembering the tricks Prometheus taught, you create a fire.");

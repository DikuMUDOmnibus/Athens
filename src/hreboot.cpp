...
/*	direct_to_char(ch, "for your feet to rest upon.\r\n");

direct_to_char(ch,"\r\nThe Goddess of All Things has divided the sea from the sky."
"\r\nShe dancing lonely upon its waves.\r\n"
"\r\nShe danced toward the south, and the wind set in motion behind her seemed \r\n"
"\rsomething new and apart with which to being a work of creation.");*/
...
void hotreboot_finalise()
{
	...
	for ( ch = player_list; ch; ch = ch->next_player )
	{
	    ...
	    /*if ( IS_AWAKE(ch))
	    {
			ch->printf("\r\nShe wheeled about, caught hold of the North Wind, and rubbed it between 
her\nhands to create Ophion, the great serpent.\r\n"
				"\r\nYou dance to warm yourself upon this great creation of Eurynome, waiting as\r\n"
				"\rthis small rememberance of Creation passes.\r\n");
			do_look (ch, "auto");
		}else{
...
void hotreboot_send_characters(char_data *ch)
{
	...
	if(ch->desc)
	{
	/*direct_to_char(ch,"\r\nLike Eurynome, the Goddess of All Things, you have risen from Chaos...\r\n");
